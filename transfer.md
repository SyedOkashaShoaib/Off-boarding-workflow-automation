    ...
    <section class="panel">
        ...
        <div class="case-detail-checklists">
            ...
            {% for task in record.tasks %}
                ...
                {% if (
                    not task.phase.is_final_approval
                    and task.responses
                ) %}
